...
class Fish{
    ...
    draw(){
        ...
        fishDirection.src = (this.x >= mouse.x) ? "img/left.png" : "img/right.png";
...
class Monster{
    constructor(){
        ...
        this.image.src = (Math.random() < 0.5) ? "img/mons1.png" : "img/mons2.png";
        ...
        for (let i = 0; i < monsterList.length; i++){
            ...
            if(monster.x < 0) monsterList.splice(i,1);
                ...
                if(checkOverlap(monster, fish)) {
                    ...
                    monsterEat.src = "audio/sound3.wav";
                    monsterEat.play();
        ...
        for (let i = 0; i < bubbleList.length; i++){
            ...
            if(bubble.y < 0 - bubble.radius*2) bubbleList.splice(i,1);
                ...
                if(bubble.distace < bubble.radius + fish.radius) {
                    ...
                    bubblePop.src = (Math.random() < 0.5) ? "audio/sound1.wav" : "audio/sound2.wav";
                    bubblePop.play();
                }
            }
        }
